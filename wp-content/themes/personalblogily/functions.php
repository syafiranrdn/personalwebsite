...
add_action('admin_menu', 'personal_blogily_themepage');
function personal_blogily_themepage()
{
	$option = get_option('personal_blogily_themepage_seen');
	$awaiting = !$option ? ' <span class="awaiting-mod">1</span>' : '';
	$theme_info = add_theme_page(__('Theme Settings', 'personal-blogily'), __('Theme Settings', 'personal-blogily').$awaiting, 'manage_options', 'personal-blogily-info.php', 'personal_blogily_info_page', 1);
}
function personal_blogily_info_page()
{
	$user = wp_get_current_user();
	$theme = wp_get_theme();
	$parent_name = is_child_theme() ? wp_get_theme($theme->Template) : '';
	$theme_name = is_child_theme() ? $theme." ".__("and", "personal-blogily")." ".$parent_name : $theme;
	$demo_text = is_child_theme() ? sprintf(__("Need inspiration? Take a moment to view our theme demo for the %s parent theme %s!", "personal-blogily"), $theme, $parent_name) : __("Need inspiration? Take a moment to view our theme demo!", "personal-blogily");
	$premium_text = is_child_theme() ? sprintf(__("Unlock all features by upgrading to the premium edition of %s and its parent theme %s.", "personal-blogily"), $theme, $parent_name) : sprintf(__("Unlock all features by upgrading to the premium edition of %s.", "personal-blogily"),$theme);
	$option_name = 'personal_blogily_themepage_seen';
		...
		<div class="spt-theme-settings-wrapper">
			<div class="spt-theme-settings-wrapper-main-content">
				<div class="spt-theme-settings-tabs">
					...
					<div class="spt-theme-settings-tab">
						...
						<label class="spt-theme-settings-label" for="tab-1"><?php esc_html_e("Get started with", "personal-blogily"); ?> <?php echo esc_html($theme_name); ?></label>
							...
							<div class="spt-theme-settings-content-getting-started-wrapper">
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Add Menus", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('nav-menus.php'))  ?>"><?php esc_html_e("Go to Menus", "personal-blogily"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Add Widgets", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('widgets.php'))  ?>"><?php esc_html_e("Go to Widgets", "personal-blogily"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Header Image", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								</div>

								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Customize Header Text & Background", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Customize Sidebar Color", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Upload Logo", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Change Background Color / Image", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Customize Blog Feed Color", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<div class="spt-theme-settings-content-item">
									<div class="spt-theme-settings-content-item-header">
										<?php esc_html_e("Customize Post/Page Color", "personal-blogily"); ?>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<a href="<?php echo esc_url(admin_url('customize.php')) ?>"><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></a>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Fonts", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize All Colors", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Import Demo Content", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Demo Import", "personal-blogily"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Contact Premium Support", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Full SEO Optimization", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize Footer Color", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Customize Navigation Color", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Make Posts & Pages Full-Width", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Unlock Elementor Compatibility", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Install Elementor", "personal-blogily"); ?></span>
									</div>
								</a>

								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Access All Child Themes", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("View Child Themes", "personal-blogily"); ?></span>
									</div>
								</a>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Add Recent Posts Widget", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Widgets", "personal-blogily"); ?></span>
									</div>
								</a>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Custom Copyright Text", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Tag' from tag page title", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Remove 'Author' from author page title", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("WooCommerce Cart in Navigation", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
								...
								<a target="_blank" href="https://superbthemes.com/personalblogily/" class="spt-theme-settings-content-item spt-theme-settings-content-item-unavailable">
									<div class="spt-theme-settings-content-item-header">
										<span><?php esc_html_e("Show Post Category on Post Feed", "personal-blogily"); ?></span> <span><?php esc_html_e("Premium", "personal-blogily"); ?></span>
									</div>
									<div class="spt-theme-settings-content-item-content">
										<span><?php esc_html_e("Go to Customizer", "personal-blogily"); ?></span>
									</div>
			...
			<div class="spt-theme-settings-wrapper-sidebar">
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Additional Resources", "personal-blogily"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<ul>
							<li>
								<a target="_blank" href="https://wordpress.org/support/forums/"><span class="dashicons dashicons-wordpress"></span><?php esc_html_e("WordPress.org Support Forum", "personal-blogily"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.facebook.com/superbthemescom/"><span class="dashicons dashicons-facebook-alt"></span><?php esc_html_e("Find us on Facebook", "personal-blogily"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://twitter.com/superbthemescom"><span class="dashicons dashicons-twitter"></span><?php esc_html_e("Find us on Twitter", "personal-blogily"); ?></a>
							</li>
							<li>
								<a target="_blank" href="https://www.instagram.com/superbthemes/"><span class="dashicons dashicons-instagram"></span><?php esc_html_e("Find us on Instagram", "personal-blogily"); ?></a>
							</li>
				...
				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("View Demo", "personal-blogily"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php echo esc_html($demo_text); ?></p>
						<a href="https://superbthemes.com/demo/personalblogily/" target="_blank" class="button button-primary"><?php esc_html_e("View Demo", "personal-blogily"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Upgrade to Premium", "personal-blogily"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php echo esc_html($premium_text); ?></p>
						<a href="https://superbthemes.com/personalblogily/" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", "personal-blogily"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Helpdesk", "personal-blogily"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php esc_html_e("If you have issues with", "personal-blogily"); ?> <?php echo esc_html($theme); ?> <?php esc_html_e("then send us an email through our website!", "personal-blogily"); ?></p>
						<a href="https://superbthemes.com/customer-support/" target="_blank" class="button"><?php esc_html_e("Contact Support", "personal-blogily"); ?></a>
					</div>
				</div>

				<div class="spt-theme-settings-wrapper-sidebar-item">
					<div class="spt-theme-settings-wrapper-sidebar-item-header"><?php esc_html_e("Review the Theme", "personal-blogily"); ?></div>
					<div class="spt-theme-settings-wrapper-sidebar-item-content">
						<p><?php esc_html_e("Do you enjoy using", "personal-blogily"); ?> <?php echo esc_html($theme); ?><?php esc_html_e("? Support us by reviewing us on WordPress.org!", "personal-blogily"); ?></p>
						<a href="https://wordpress.org/support/theme/<?php echo esc_attr(get_stylesheet()); ?>/reviews/#new-post" target="_blank" class="button"><?php esc_html_e("Leave a Review", "personal-blogily"); ?></a>
					</div>
				</div>
...
function personal_blogily_comparepage_css($hook) {
	if ('appearance_page_personal-blogily-info' != $hook) {
		return;
	}
	wp_enqueue_style('personal-blogily-custom-style', get_template_directory_uri() . '/css/compare.css');
}
add_action('admin_enqueue_scripts', 'personal_blogily_comparepage_css');
